...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS Files -->
        <link href="{{ asset('assets/backend') }}/css/material-dashboard.css?v=2.1.1" rel="stylesheet" />
    ...
    <script src="{{ asset('assets/backend') }}/js/material-dashboard.js?v=2.1.1" type="text/javascript"></script>
